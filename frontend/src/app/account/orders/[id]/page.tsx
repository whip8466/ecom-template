                      ...
                      <tr key={item.id} className="border-b border-[#edf2f8] last:border-0">
                        <td className="px-4 py-4">
                          <div className="flex items-center gap-3">
                            <ItemThumb item={item} />
                            <Link href={href} className="font-medium text-[var(--sf-btn-primary-bg)] hover:text-[var(--sf-btn-primary-hover)] hover:underline">
                ...
                <ul className="mt-4 space-y-3 text-sm text-[#475467]">
                  {u?.name && (
                    <li className="flex gap-2">
                      <span className="shrink-0 text-[var(--sf-btn-primary-bg)]">
                  ...
                  {u?.email && (
                    <li className="flex gap-2">
                      ...
                      <a href={`mailto:${u.email}`} className="text-[var(--sf-btn-primary-bg)] hover:underline">
                        {u.email}
                      </a>
                    </li>
                  )}
                  {u?.phone && (
                    <li className="flex gap-2">
                      ...
                      <a href={`tel:${u.phone.replace(/\s/g, '')}`} className="text-[var(--sf-btn-primary-bg)] hover:underline">
                        {u.phone}
                      </a>
                    </li>
                  )}
